    ...
    return (
        <View className="flex items-center w-full ">
            ...
            <TouchableOpacity
                ...
                onPress={handlePress}
            >
                <Text className="text-white text-[20.7px] font-bold flex-shrink text-center">
                    Get ONE Click help
                </Text>
            </TouchableOpacity>
        </View>
    ...
    return (
        <View className="flex-1 items-center bg-white w-[90%] my-3 rounded-3xl ">
                ...
                <View className="flex-1 justify-center p-3 gap-7">
                    ...
                    <View className="flex-row items-center w-full  gap-3">
                        <Image resizeMode="contain" source={require('../assets/images/check2.png')} style={{width: 18, height: 14}}/>
                        <Text className=" flex flex-shrink font-semibold text-[14px]">{t('Miss it now, 2 years later')}</Text>
                    </View>
                    <View className="flex-row items-center w-full  gap-3">
                        <Image resizeMode="contain" source={require('../assets/images/check2.png')} style={{width: 18, height: 14}}/>
